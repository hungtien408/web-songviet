<%@ Page Title="" Language="C#" MasterPageFile="~/en/site.master" AutoEventWireup="true" CodeFile="san-pham-ung-dung.aspx.cs" Inherits="san_pham_ung_dung" %>
                        ...
                        <div class="content_pro_tit">
                            ...
                            <div class="list-all">
                                <ul>
                                    ...
                                    <li><a style="font-weight:bold;  color: #b5152b;" href='<%# progressTitle(Eval("ProductNameEn")) + "-ud-" + Eval("ProductID") + ".aspx" %>'>
                                        <span>
