<%@ Page Title="" Language="C#" MasterPageFile="~/en/site.master" AutoEventWireup="true" CodeFile="san-pham-dac-diem.aspx.cs" Inherits="san_pham_dac_diem" %>
                        ...
                        <div class="content_pro_tit">
                            ...
                            <div class="list-all">
                                <ul>
                                    ...
                                    <li><a style="font-weight:bold;  color: #b5152b;" href='<%# progressTitle(Eval("ProductNameEn")) + "-dd-" + Eval("ProductID") + ".aspx" %>'>
                                        <span>
