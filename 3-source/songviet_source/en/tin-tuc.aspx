<%@ Page Title="" Language="C#" MasterPageFile="~/en/site.master" AutoEventWireup="true" CodeFile="tin-tuc.aspx.cs" Inherits="tin_tuc" %>
                ...
                <asp:ListView ID="lstNewHot1" runat="server" DataSourceID="odsNewHot1"
                    ...
                    <ItemTemplate>
                        <div class="main-tintuc">
                            <div class="img">
                                <a href='<%# progressTitle(Eval("ProductNameEn")) + "-nw-" + Eval("ProductID") + ".aspx" %>'>
                                    <img id="Img1" alt='<%# Eval("ProductNameEn") %> ' src='<%# "~/res/product/" + Eval("ImageName") %>'
                                        visible='<%# string.IsNullOrEmpty( Eval("ImageName").ToString()) ? false : true %>'
                                        runat="server" /></a>
                            </div>
                            <div class="content">
                                <a href='<%# progressTitle(Eval("ProductName")) + "-nw-" + Eval("ProductID") + ".aspx" %>'><%# Eval("ProductNameEn") %></a>
                                <p><%# Eval("DescriptionEn") %></p>
                                <div class="read-more">
                                    <a href='<%# progressTitle(Eval("ProductNameEn")) + "-nw-" + Eval("ProductID") + ".aspx" %>'>Xem thêm <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                    </ItemTemplate>
                ...
                <asp:ListView ID="lstNews" runat="server" DataSourceID="odsNews"
                    ...
                    <ItemTemplate>
                        <div class="item">
                            ...
                            <div class="content">
                                <a href='<%# progressTitle(Eval("ProductNameEn")) + "-nw-" + Eval("ProductID") + ".aspx" %>'><%# Eval("ProductNameEn") %></a>
                                <p><%# Eval("DescriptionEn") %></p>
                            </div>
                        </div>
                    </ItemTemplate>
