<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="san-pham-dac-diem.aspx.cs" Inherits="san_pham_dac_diem" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container">
        ...
        <div class="content_pro">
            <asp:ListView ID="lstDacDiem" runat="server" DataSourceID="odsDacDiem" EnableModelValidation="True">
                <ItemTemplate>
                        ...
                        <div class="content_pro_tit">
                            ...
                            <div class="list-all">
                                <ul>
                                    ...
                                    <li><a href='<%# progressTitle(Eval("ProductName")) + "-ud-" + Eval("ProductID") + ".aspx" %>'>
                                        <span>
                                            <img src="assets/images/icon2.png" alt="" /></span>Ứng dụng</a></li>
                                    <li><a style="font-weight:bold;  color: #b5152b;" href='<%# progressTitle(Eval("ProductName")) + "-dd-" + Eval("ProductID") + ".aspx" %>'>
                                        <span>
            ...
            <asp:ObjectDataSource ID="odsDacDiem" runat="server" SelectMethod="ProductSelectOne"
                TypeName="TLLib.Product">
                <SelectParameters>
                    <asp:QueryStringParameter Name="ProductID" QueryStringField="dd" Type="String" />
                </SelectParameters>
            </asp:ObjectDataSource>
            <div class="clr">
            </div>
