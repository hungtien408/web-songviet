        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn DataField="ProductName" HeaderText="Hotline" SortExpression="ProductName" />
                                                ...
                                                <table class="search">
                                                    <tr class="invisible">
                                                        ...
                                                        <td runat="server">
                                                            ...
                                                            <span class="required">(Kích thước 270px x 184px)</span>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadTextBox ID="txtProductName" runat="server" Text='<%# Bind("ProductName") %>'
                                                                Width="500px" EmptyMessage="Hotline...">
                                                            </asp:RadTextBox>
