                    ...
                    <ItemTemplate>
                        <div class="address-contact">
                            ...
                            <p class='<%# string.IsNullOrEmpty(Eval("MetaDescription").ToString()) ? "hidden" : "" %>'>
                                ...
                                <a href='<%# "mailTo:" + Eval("MetaDescription")%>'><%# Eval("MetaDescription")%></a></p>
                            <p class='<%# string.IsNullOrEmpty(Eval("Content").ToString()) ? "hidden" : "" %>'>
                                <span class="fa fa-globe"></span><a class="btn-ut" href="javascript:void(0);">Bản đồ</a></p>
                            <div class='<%# string.IsNullOrEmpty(Eval("Content").ToString()) ? "hidden" : "map-iframe" %>'>
                                <%# Eval("Content") %>
                            </div>
                        </div>
                    </ItemTemplate>
