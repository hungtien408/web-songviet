    ...
    public class Product
    {
        ...
        )
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Priority", string.IsNullOrEmpty(Priority) ? dbNULL : (object)Priority);
                cmd.Parameters.AddWithValue("@IsAvailable", string.IsNullOrEmpty(IsAvailable) ? dbNULL : (object)IsAvailable);
                cmd.Parameters.AddWithValue("@ThongSo", string.IsNullOrEmpty(ThongSo) ? dbNULL : (object)ThongSo);
                cmd.Parameters.AddWithValue("@UngDung", string.IsNullOrEmpty(UngDung) ? dbNULL : (object)UngDung);
                cmd.Parameters.AddWithValue("@DacDiem", string.IsNullOrEmpty(DacDiem) ? dbNULL : (object)DacDiem);
                cmd.Parameters.AddWithValue("@ThongSoEn", string.IsNullOrEmpty(ThongSoEn) ? dbNULL : (object)ThongSoEn);
                cmd.Parameters.AddWithValue("@UngDungEn", string.IsNullOrEmpty(UngDungEn) ? dbNULL : (object)UngDungEn);
                cmd.Parameters.AddWithValue("@DacDiemEn", string.IsNullOrEmpty(DacDiemEn) ? dbNULL : (object)DacDiemEn);
